...
right = 1.6;
epsilon = 0.0001;
[root, iterations, tol] = Inverse_Linear_Interpolation(f, left, right, epsilon);
...
function [result, iterations, tol] = Inverse_Linear_Interpolation(function_f, left, right, epsilon)
